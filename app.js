...
function multiply(a, b) { //eslint-disable-line
  var productNum = a * b;
  var productString = 'The product of ' + a + ' and ' + b + ' is ' + productNum + '.';
  return [productNum, productString];
}
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var prodOfThree = multiply(prodOfTwo,c)[0];
  var prodofThreeString = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + prodOfThree + '.';

  return [sumOfThree, prodOfThree, sumOfThreeString, prodofThreeString];
}
